...
date: 2017-10-24 11:07:00
updated: 2017-10-24 11:07:00
tags:
categories: BackEnd
---
...
API 与用户的通信协议，总是使用 [HTTPs协议](http://www.ruanyifeng.com/blog/2014/02/ssl_tls.html)。
...
* 406 Not  - [GET]：用户请求的格式不可得（比如用户请求JSON格式，但是只有XML格式）。
* 410 Gone -[GAcceptableET]：用户请求的资源被永久删除，且不会再得到的。
...
## 参考
- [RESTful API 设计指南](http://www.bshare.cn/share)
