...
```javascript
document.location.replace('http://www.example.com/otherpage.html');
```
...
<body onLoad="start()">
    <iframe id="myiframe" style="width:300px; height:200px; border:1;"></iframe> <br>

    <button onclick="toggle()">toggleDesignMode</button>
...
实例可以参考 [HTML DOM importNode() 方法](http://www.runoob.com/jsref/met-document-importnode.html)
