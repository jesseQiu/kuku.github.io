...
f() // chrome 版本 52.0.2743.82 m 测试报：VM850:4 Uncaught TypeError: f is not a function(…) 
```
...
var f2 = function () {};
f2.name // 'f2' // chrome 52.0.2743.82 版本测试
...
var multiline = function (fn) {
  ...
  var fnArray = fnString.split('\n');
  console.log(`fnArray: ${JSON.stringify(fnArray)}`);

  var fnSlice = fnArray.slice(1, fnArray.length - 1);
  console.log(`fnArray: ${JSON.stringify(fnSlice)}`);

  var fnJoin = fnSlice.join('\n');
  console.log(`fnJoin: ${fnJoin}`);
