---
title: 浏览器同源政策及其规避方法
date: 2016-10-18 14:13:32
updated: 2016-10-18 14:13:32
tags:
categories: BackEnd 
feature:
---
...
举例来说，A
网页是 `http://w1.example.com/a.html`，B 网页是 `http://w2.example.com/b.html`，那么只要设置相同的 `document.domain`，两个网页就可以共享 Cookie。
...
详细可以参考 [Jsonp 实现原理](/2016/10/17/jsonp-实现原理/)
...
详细可以参考 [Cors 原理解析](/2016/10/17/cors-原理解析/)
